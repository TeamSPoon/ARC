...
tesT_compare_objects:- compare_objects([
    obj([mass(1),colorless_points([point_01_01]),colors_cc([cc(yellow,1.0)]),localpoints([yellow-point_01_01]),
