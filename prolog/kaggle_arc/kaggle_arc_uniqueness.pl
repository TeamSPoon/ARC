...
compute_scene_change_pass3a(TestID,IO_-P):- 
   ...
   update_accompany_changed_db(pass3a_m_unifiers,TestID,IO_,P,ListR).
...
is_unbound_prop(S):- \+ ground(S), make_unifiable(S,DS), S=@=DS,!.
