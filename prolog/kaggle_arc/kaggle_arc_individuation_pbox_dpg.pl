...
pbox_vm(VM):- !,
  ...
  %begin_i_pbox_l(Grid,NSEW,XSG,Points,  Points2,VM,s_l(1),Sizes_L_S), if_t(Points\==Points2,gset(VM.lo_points)=Points2),
  begin_i_pbox_l(Grid,NSEW,XSG,Points,  Points1,VM,s_l(1),Sizes_S_L), if_t(Points\==Points1,gset(VM.lo_points)=Points1),
  %begin_i_pbox_l(Grid,NSEW,XSG,Points1, Points2,VM,l_s(2),Sizes_L_S), if_t(Points\==Points2,gset(VM.lo_points)=Points2),
  %begin_i_pbox_l(Grid,NSEW,XSG,Points,  Points3,VM,l_s(1),Sizes_L_S), if_t(Points\==Points3,gset(VM.lo_points)=Points3),
  % begin_i_pbox_l(Grid,NSEW,XSG,Points3, Points9,VM,s_l(2),Sizes_S_L), if_t(Points\==Points9,gset(VM.lo_points)=Points9),
  !.
...
pbox_io(TestID,ExampleNum,IO,G0):-
  ...
  u_dmsg(?- pbox_io(TestID,ExampleNum,IO)),
...
i_pbox_l(SoFar,SoFar,_Grid,_NSEW,_XSG,Points,Points,_VM,L_S,_):- Points==[], !, u_dmsg(pointless(L_S)).
i_pbox_l(SoFar,SoFar,_Grid,_NSEW,_XSG,Points,Points,_VM,L_S,[]):- !, u_dmsg(complete(L_S)).
%i_pbox_l(_Grid,_NSEW,_XSG,Points,Points,_VM,L_S,_):- L_S \= s_l(2), L_S \= l_s(1), experiment(L_S \= l_s(2)), !, u_dmsg(complete(L_S)).
%i_pbox_l(_Grid,_NSEW,_XSG,Points,Points,_VM,L_S,_):- L_S \= s_l(1), L_S \= l_s(1), experiment(L_S \= l_s(2)), !, u_dmsg(complete(L_S)).
