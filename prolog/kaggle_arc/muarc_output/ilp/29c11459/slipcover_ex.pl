...
lhs(trn_0,1,2,blue,1,1,sameR,1,'[[0]]',[]). 
lhs(trn_0,11,2,red,1,1,sameR,1,'[[0]]',[]). 
lhs(trn_1,1,4,green,1,1,sameR,1,'[[0]]',[]). 
lhs(trn_1,11,4,orange,1,1,sameR,1,'[[0]]',[]). 
:-end_bg. 
:-begin_in_pos. 
pos(rhs(trn_0,2,2,blue,4,1,sameR,4,'[[-,-,-,-]]',[])). 
pos(rhs(trn_0,7,2,red,4,1,sameR,4,'[[-,-,-,-]]',[])). 
pos(rhs(trn_0,2,2,black,1,9,rot90,9,'[[|],[|],[|],[|],[|],[|],[|],[|],[|]]',[])). 
pos(rhs(trn_0,1,2,blue,1,1,sameR,1,'[[0]]',[])). 
pos(rhs(trn_0,6,2,silver,1,1,sameR,1,'[[0]]',[])). 
pos(rhs(trn_0,11,2,red,1,1,sameR,1,'[[0]]',[])). 
pos(rhs(trn_1,2,2,blue,4,1,sameR,4,'[[-,-,-,-]]',[])). 
pos(rhs(trn_1,7,2,red,4,1,sameR,4,'[[-,-,-,-]]',[])). 
pos(rhs(trn_1,2,2,black,1,9,rot90,9,'[[|],[|],[|],[|],[|],[|],[|],[|],[|]]',[])). 
pos(rhs(trn_1,1,2,blue,1,1,sameR,1,'[[0]]',[])). 
pos(rhs(trn_1,6,2,silver,1,1,sameR,1,'[[0]]',[])). 
pos(rhs(trn_1,11,2,red,1,1,sameR,1,'[[0]]',[])). 
:-end_in_pos. 
