...
:-end_bg. 
:-begin_in_pos. 
pos(rhs(trn_0,hv(1,2),sameR,red,hv(2,2),hv(2,2),4,sid_22)). 
pos(rhs(trn_2,hv(2,3),sameR,red,hv(3,1),hv(3,1),3,sid_13)). 
/*
pos(rhs(tst_0,hv(2,2),rot90,red,hv(3,2),hv(2,3),4,s15307279)). 
*/
:-end_in_pos. 
/*
*/
