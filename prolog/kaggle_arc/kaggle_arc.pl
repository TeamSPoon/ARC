...
u_dmsg(M):- stream_property(UE,file_no(2)),!,
    with_toplevel_pp(ansi, with_output_to(UE,fmt(M))).
u_dmsg(M):- stream_property(UE,file_no(2)), stream_property(UO,file_no(1)), current_output(CO),!,
  (UO==CO ->  dmsg(M) ; 
