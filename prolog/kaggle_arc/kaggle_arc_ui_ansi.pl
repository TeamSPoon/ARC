...
print_side_by_side(Title=Value):- print_list_of(print_ss,Title,Value),!.
...
call_w_pad(N,Goal):- nl_if_needed,wots(S,dash_chars(N,' ')),!,pre_pend_each_line(S,Goal).
