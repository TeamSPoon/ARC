...
% % :- include('../arc_two/kaggle_arc_header').
...
:- set_prolog_flag(arc_term_expansion, false).
:- ensure_loaded('../arc_two/kaggle_arc_precompiler').
/*
...
ld_logicmoo_webui:-
  ...
  ensure_loaded(arc_two(kaggle_arc_ui_html_wss)),
  ensure_loaded(arc_two(kaggle_arc_ui_html)),!.
...
user:file_search_path(arc_two,  Dir):- absolute_file_name('../arc_two/',Dir).
%:- set_prolog_flag(verbose_load,true).  
%:- set_prolog_flag(verbose_autoload,true).
...
:- ensure_loaded(arc_two(kaggle_arc_utils)).
:- ensure_loaded(arc_two(kaggle_arc_ui_html)).
:- ensure_loaded(arc_two(kaggle_arc_ui_ansi)).

:- ensure_loaded(arc_two(kaggle_arc_test_favs)).

:- ensure_loaded(arc_two('../kaggle_arc/logical_ml/muarc_dmiles')).

:- ensure_loaded(arc_two(kaggle_arc_test_loader)).

:- ensure_loaded(arc_two(kaggle_arc_explaination)).
:- ensure_loaded(arc_two(kaggle_arc_heuristics)).
:- ensure_loaded(arc_two(kaggle_arc_intruder)).
:- ensure_loaded(arc_two(kaggle_arc_test_cache)).

:- ensure_loaded(arc_two(kaggle_arc_test_easy)).
:- ensure_loaded(arc_two(kaggle_arc_test_old)).


:- ensure_loaded(arc_two(kaggle_arc_learning)).


:- ensure_loaded(arc_two(kaggle_arc_deepening)).
:- ensure_loaded(arc_two(kaggle_arc_imageproc)).
:- ensure_loaded(arc_two(kaggle_arc_typecheck)).
:- ensure_loaded(arc_two(kaggle_arc_interpreter)).
:- ensure_loaded(arc_two(kaggle_arc_physics)).
:- ensure_loaded(arc_two(kaggle_arc_recognise)).

:- ensure_loaded(arc_two(kaggle_arc_domaintypes)).
:- ensure_loaded(arc_two(kaggle_arc_imagens)).
:- ensure_loaded(arc_two(kaggle_arc_db)).
:- ensure_loaded(arc_two(kaggle_arc_boards)).

:- ensure_loaded(arc_two(kaggle_arc_individuation)).
:- ensure_loaded(arc_two(kaggle_arc_uniqueness)).
:- ensure_loaded(arc_two(kaggle_arc_howdiff)).
:- ensure_loaded(arc_two(kaggle_arc_transrules)).
:- ensure_loaded(arc_two(kaggle_arc_object)).
:- ensure_loaded(arc_two(kaggle_arc_generalization)).

:- ensure_loaded(arc_two(kaggle_arc_test_iface)).
...
:- ensure_loaded(arc_two(kaggle_arc_simple)).
...
%:- ensure_loaded(arc_two('kaggle_arc_fwd.pfc')).
:- set_prolog_flag(arc_term_expansion, true).
...
suggested_eval_directory('/data/evaluation/').
suggested_eval_directory('./secret_data/evaluation/').
suggested_eval_directory('../../secret_data/evaluation/').

suggest_eval_directory(Direct):- suggested_eval_directory(Dir), arc_sub_path(Dir,Direct),exists_directory(Direct).

load_task_states:- suggest_eval_directory(Dir), catch_log(load_json_files(evaluation,v,Dir)),!.
...
:- ensure_loaded(arc_two(kaggle_arc_two)).
...
:- initialization(user:arc_ui_ansi_isc).
