...
lhs(trn_0,7,2,cyan,2,2,rot180,3,'[[0,!],[-,+]]',[]). 
lhs(trn_0,4,10,green,2,2,rot270,3,'[[0,!],[-,+]]',[]). 
lhs(trn_0,2,4,red,2,2,rot90,3,'[[0,!],[-,+]]',[]). 
lhs(trn_0,8,8,blue,2,2,sameR,3,'[[0,!],[-,+]]',[]). 
lhs(trn_1,3,4,blue,2,2,rot180,3,'[[0,!],[-,+]]',[]). 
lhs(trn_1,5,10,yellow,2,2,rot270,3,'[[0,!],[-,+]]',[]). 
lhs(trn_1,9,2,cyan,2,2,rot90,3,'[[0,!],[-,+]]',[]). 
lhs(trn_1,8,6,red,2,2,sameR,3,'[[0,!],[-,+]]',[]). 
:-end_bg. 
:-begin_in_pos. 
pos(rhs(trn_0,1,1,cyan,2,2,rot180,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_0,1,3,green,2,2,rot270,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_0,3,1,red,2,2,rot90,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_0,3,3,blue,2,2,sameR,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_1,1,1,blue,2,2,rot180,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_1,1,3,yellow,2,2,rot270,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_1,3,1,cyan,2,2,rot90,3,'[[0,!],[-,+]]',[])). 
pos(rhs(trn_1,3,3,red,2,2,sameR,3,'[[0,!],[-,+]]',[])). 
:-end_in_pos. 
